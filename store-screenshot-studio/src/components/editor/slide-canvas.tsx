...
function backgroundFor(theme: Theme, inverted?: boolean) {
  if (theme.id === "fortale-cosmos") {
    if (inverted) {
      return "radial-gradient(circle at 82% 10%, rgba(155,199,255,0.55), transparent 34%), linear-gradient(160deg, #F3F8FF 0%, #DCEBFF 56%, #C7DFFF 100%)";
    }
    return "radial-gradient(circle at 17% 0%, rgba(80,118,172,0.34), transparent 34%), radial-gradient(circle at 84% 9%, rgba(74,112,168,0.27), transparent 34%), linear-gradient(180deg, #061224 0%, #0B2342 48%, #214C7A 100%)";
  }
  if (inverted) {
