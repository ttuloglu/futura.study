...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorCommunityPhotoviewer", path: "../../../node_modules/@capacitor-community/photoviewer"),
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "CapacitorCommunityPhotoviewer", package: "CapacitorCommunityPhotoviewer"),
